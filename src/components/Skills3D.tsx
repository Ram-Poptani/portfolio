...
const skillItems = [
  ...
  { name: "Spring Data JPA", icon: "/icons/spring-data-jpa.svg", category: "lang", proficiency: 85 },
  { name: "Hibernate/JPA", icon: "/icons/hibernate.svg", category: "lang", proficiency: 88 },
