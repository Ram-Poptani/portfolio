...
const skillItems = [
  ...
  { name: "JavaScript", icon: "/icons/javascript.svg", category: "lang", proficiency: 85 },
  { name: "TypeScript", icon: "/icons/typescript.svg", category: "lang", proficiency: 82 },
  { name: "Express.js", icon: "/icons/express.svg", category: "lang", proficiency: 80 },
